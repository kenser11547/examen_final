            ...
            <form action="/final_caaljuc/controladores/citas/guardar.php" method="POST" class="col-lg-8 border bg-light p-3">
                ...
                <div class="row mb-3">
                    <div class="col-lg-8">
                        ...
                        <select name="cita_medico" id="cita_medico" class="form-control">
                            ...
                            <?php foreach ($medicos as $key => $medico) : ?>
                                <option value="<?= $medico['MEDICO_ID'] ?>"><?= $medico['MEDICO_NOMBRE'] . " - " . $medico['MEDICO_CLINICA'] ?></option>
                            <?php endforeach?>
                        </select>
                    </div>
                    <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="time-local" value="<?= date('H:i') ?>" name="cita_hora" id="cita_hora" class="form-control">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
